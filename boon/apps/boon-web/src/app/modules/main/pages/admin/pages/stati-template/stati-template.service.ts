...
import { StatoTemplateResExcerptDto, TenantResDto } from '../../../../../../../api/models';
import { TemplateStatiTemplateApiClient } from '../../../../../../../api/services';
...
export class StatiTemplateService {
  ...
  editTemplate(stato: StatoTemplateResExcerptDto, tenant: TenantResDto) {
    const params = {
      id: stato.id,
      tenat: tenant,
      body: {
    ...
    return this.templateStatiTemplateApiClient.statiTemplateControllerUpdateStatoTemplate(params).pipe(
      tap(() => {
        this.messageService.add({
          severity: 'success',
          summary: `Success`,
